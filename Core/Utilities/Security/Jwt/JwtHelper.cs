...
using Core.Utilities.Security.Encption;
...
namespace Core.Utilities.Security.Jwt
{
    public class JwtHelper : ITokenHelper
    {
        ...
        {
            var securtiyKey = SecurityKeyHelper.CreateSecurityKey(_tokenOptions.SecurityKey);
            var signingCredentials = SigningCredentialHelper.CreateSigningCredentials(securtiyKey);
